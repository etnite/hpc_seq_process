...
ref_gen="/lustre/project/genolabswheatphg/v2_refseq/iwgsc_refseqv2.0_all_chromosomes.fa"
regions_file="/home/brian.ward/region_files/v2_100Mb_window_regions.txt"
out_dir="/project/guedira_seq_map/brian/US_excap/v2_variants/region_bcfs"
mq_val=20
