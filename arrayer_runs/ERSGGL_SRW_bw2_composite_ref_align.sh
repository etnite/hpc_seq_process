...
#SBATCH --array=1-58%8  #array range - can choose number simultaneous jobs with %, e.g. --array=1-12%4
...
script="/home/brian.ward/repos/hpc_seq_process/code/alignment/bowtie2_PE_align_parallel.sh"
