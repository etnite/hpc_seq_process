...
#SBATCH --job-name="bam2fq"  #name of the job submitted
#SBATCH --partition=short  #name of the queue you are submitting job to
#SBATCH --array=1-58%20  #array range - can choose number simultaneous jobs with %, e.g. --array=1-12%4
...
script="/home/brian.ward/repos/hpc_seq_process/code/bam_manipulations/bam_to_fastq_parallel.sh"
